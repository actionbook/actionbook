...
- [`889cfc7`](https://github.com/actionbook/actionbook/commit/889cfc7fe45e6d502128f530b1fdcbff5f3f0d05) Thanks [@mcfn](https://github.com/mcfn)! - - Fix duplicate short tab IDs after drag-out-drag-in in extension mode (ACT-986): `push_tab` skips already-occupied candidates; `push_tab_with_id` advances auto-counter past t{n}-style custom IDs
