 ...
 *
 * Provides unified interfaces for AI capabilities (embedding, completion, etc.)
 ...
 * Implement this interface to add support for new embedding providers
 */
 ...
 */
export type EmbeddingProviderType = 'openai' | 'cohere' | 'voyager' | 'local';
